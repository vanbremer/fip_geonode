...
from fip_geonode import get_version
from fip_geonode.celeryapp import app  # flake8: noqa
import djcelery
...
SECRET_KEY = os.getenv('SECRET_KEY', "s2@$k9g-j6mq=i59br)n!f8hlx46#k+0tqz(zn4lw=3x-=)i8g")
...
ROOT_URLCONF = os.getenv('ROOT_URLCONF', 'fip_geonode.urls')
...
_DEFAULT_PYSCSW = {
    ...
    'CONFIGURATION': {
        ...
        #},
        'metadata:main': {
            'identification_title': 'fip_geonode Catalogue',
            ...
            'identification_keywords': 'sdi,catalogue,discovery,metadata,GeoNode, fip_geonode',
